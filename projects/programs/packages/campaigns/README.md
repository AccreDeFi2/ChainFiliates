...
2. **Create Campaign Details Doc**  
   ...
   ```json
   {
   	...
   	"external_link": "https://chainfiliates.so?ref=test-campaign",
   	"image": "https://chainfiliates-pub.s3.amazonaws.com/app/chainfiliates-logo-medium.png"
   }
   ```
...
3. **Create a Campaign**  
   ...
   2. you then must submit the Arweave Transaction ID to the ChainFiliates API where it is then indexed.
...
- ChainFiliates Campaigns Typescript Docs: [https://ts-docs.programs.chainfiliates.so/modules/ChainFiliates_Campaigns](https://ts-docs.programs.chainfiliates.so/modules/ChainFiliates_Campaigns)
