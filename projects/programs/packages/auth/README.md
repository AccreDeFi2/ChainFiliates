...
The ChainFiliates Auth module abstracts authentication with different wallets and authentication methods.  
...
- ChainFiliates Auth Typescript Docs: [https://ts-docs.programs.chainfiliates.so/modules/ChainFiliates_Auth](https://ts-docs.programs.chainfiliates.so/modules/ChainFiliates_Auth)
