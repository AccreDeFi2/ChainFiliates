# 📖 Welcome to ChainFiliates Documentation repository

Welcome to the ChainFiliates documentation repository! Here, our goal is to help our users unleash the full potential of ChainFiliates,
allowing them to effectively manage and grow their partner networks, streamline referral programs, and seamlessly
integrate ChainFiliates into their Web2 and Web3 projects.

For more information about the ChainFiliates project, its source code, and technical details, please visit the [ChainFiliates Organization Profile](https://github.com/chainfiliateslabs). You will find the ChainFiliates Core, ChainFiliates.js, and ChainFiliates
Programs components repositories, along with instructions on how to set up and deploy your instance of ChainFiliates.
...
1. **Report issues**: If you find any errors, inconsistencies, or areas that need improvement, please open an issue on
   the [GitHub main repository](https://github.com/chainfiliateslabs/chainfiliates/issues). Provide a clear description of the issue and
...
2. **Suggest enhancements**: If you have ideas for new sections, topics, or content that would be helpful to others,
   ...
   the [GitHub main repository](https://github.com/chainfiliateslabs/chainfiliates/issues).
...
**Note**: If you want to contribute to ChainFiliates source code itself, please visit
the [ChainFiliates main repository](https://github.com/chainfiliateslabs/chainfiliates) and follow the contribution guidelines.
