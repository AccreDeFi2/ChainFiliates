...
ChainFiliates is a platform built on trust, transparency, and security principles. This section outlines the various security
measures the ChainFiliates stack incorporates to mitigate risks of fraud, safeguard user data, and ensure a reliable platform
experience.
...
ChainFiliates uses [Humanode](https://humanode.io/) to facilitate biometrics processing, ensuring a unique human being
...
ChainFiliates takes a proactive approach to bot prevention, ensuring that your partnerships remain spam-free and focused on real
human users.

### BotD: The First Line of Defense

ChainFiliates Invite Links embed a bot detection framework by the team at [https://fingerprint.com/](https://fingerprint.com/).
This technology is trained to determine whether a browser is real, or emulated.

### HCaptcha: The Last Line of Defense

ChainFiliates employs the HCaptcha system to truly differentiate between bots and humans. This technology protects both the
Partner UI (preventing spam account creation) and the Invite system (verifying the humanity of Referred Users).

## Key Takeaways

ChainFiliates's comprehensive security measures are designed to instil confidence in the platform's reliability and protect
users from potential risks. Using personhood verification and bot prevention, ChainFiliates creates an environment where users
