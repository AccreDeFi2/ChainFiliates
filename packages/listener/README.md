...
There are currently two kinds of conversion events in ChainFiliates. Smart contract or web-based conversions. The listener helps to build the process of smart-contract ones.
