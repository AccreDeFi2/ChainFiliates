...
const config: FaviconOptions & { sourceIconPath: string } = {
	...
	appName: "ChainFiliates", // Your application's name. `string`
	appShortName: "ChainFiliates", // Your application's short_name. `string`. Optional. If not set, appName will be used
	manifestRelativePaths: true,
	appDescription:
		"ChainFiliates is the open partnerships platform enabling partner networks with crypto remittances", // Your application's description. `string`
