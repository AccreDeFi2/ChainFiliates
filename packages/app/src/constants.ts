...
// ? chainfiliatesUrl can remain '/api' across environments here because the API is apart of this NEXT app.
export const API_OPTIONS = byTargetEnv<ApiOptions>({
	p: new ApiOptions({
		environment: "production",
		chainfiliatesUrl: "/api",
		ceramicUrl
	}),
	s: new ApiOptions({ environment: "staging", chainfiliatesUrl: "/api", ceramicUrl }),
	d: new ApiOptions({
