...
const config = {
	// use title case here. E.g.: ChainFiliates
	companyName: "ChainFiliates",
	...
	logomark: {
		...
		colors: {
			primary: "#2C9CF2", // Main color for links, buttons, and highlights
			sidePanel: "#0A1B30",
			links: "#2C9CF2"
		},
	/**
	...
	menuItems: [
		...
		{
			href: "https://docs.chainfiliates.so/?ref=app",
			text: "Docs",
		...
		{
			href: "https://github.com/chainfiliateslabs",
			text: "GitHub",
