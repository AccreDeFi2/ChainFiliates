...
This package builds into a CLI that enables you to execute some administrative functions on your ChainFiliates node.
...
| CERAMIC_URL          | Set this to use a Ceramic URL. https://ceramic.chainfiliates.so/ for Production and https://ceramic-clay.3boxlabs.com/ development.                                |
...
Commands:
  schema          Manage ChainFiliates Ceramic Schema
  tile            Manage ChainFiliates Ceramic Tiles
  definition      Manage ChainFiliates Ceramic Definitions
  arweave         Manage Arweave
  app             Admin utils for the Next.js ChainFiliates dApp
...
Get Auth Token for use with Next.js ChainFiliates dApp API
...
- `--host, -h <string>`: dApp host/origin (default: https://app.chainfiliates.so)
