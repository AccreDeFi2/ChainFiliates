<div align="center">
  <h1>ChainFiliates Web3 Referrals</h1>
	<div>
		<span>
...
<div align="center">
   <a href="https://www.chainfiliates.so/referrals?ref=github">Website</a>
   <span> | </span>
   <a href="https://chainfiliateslabs.github.io/chainfiliates-referrals/?ref=github">Documentation</a>
   <span> | </span>
...
<img alt="Partner Portal 1" src="https://raw.githubusercontent.com/chainfiliateslabs/chainfiliates/master/images/docs/partner-portal-1.jpeg" width="720px">
<img alt="Partner Portal 2" src="https://raw.githubusercontent.com/chainfiliateslabs/chainfiliates/master/images/docs/partner-portal-2.jpeg" width="720px">
<img alt="Partner Portal 3" src="https://raw.githubusercontent.com/chainfiliateslabs/chainfiliates/master/images/docs/partner-portal-3.jpeg" width="720px">
...
ChainFiliates is being designed to interoperate with decentralised systems to yield the fairest outcomes for all participants.
...
The goal is to ensure **any Brand can leverage ChainFiliates** whether they're a [DeFi](https://www.investopedia.com/decentralized-finance-defi-5113835) Protocol, an [eCommerce](https://sell.amazon.com/learn/what-is-ecommerce) store, or even a Content Creator!
...
_An Operator is an entity or individual responsible for deploying and managing an ChainFiliates instance._
...
1. Deploy the ChainFiliates Stack.
2. Invite your community to your ChainFiliates instance to seed the partner network.
...
[Homepage →](https://chainfiliates.so/referrals)

[Documentation →](https://chainfiliateslabs.github.io/chainfiliates-referrals/)

[Create Campaigns & Embed ChainFiliates in your Application →](https://github.com/chainfiliateslabs/programs)

[Track Conversion Events in Web Apps with ChainFiliates.js →](https://chainfiliateslabs.github.io/chainfiliates-referrals/integrating-with-chainfiliatesjs/what-is-chainfiliatesjs)

## 🌟 Features

ChainFiliates Core encompasses the necessary code to run:
...
![ChainFiliates core architecture](images/docs/CoreArchitecture.png)

- **Core Web App**: ChainFiliates Core's central component is a **[NextJS](https://nextjs.org/)**-based Application that provides an accessible and user-friendly interface for managing campaigns. It also ensures smooth interaction with other services by employing deployed serverless functions.
- **User-owned Database**: By leveraging **[Ceramic](https://ceramic.network/)**'s decentralized data storage network, ChainFiliates Core provides a secure and user-centric data management solution. Ceramic schemas ensure organized and consistent data storage for elements like partnerships, campaign details, and advertiser profiles while allowing users to maintain control over their data.
...
| ---------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| [packages/admin](./packages/admin)       | CLI for executing administrative functions on the ChainFiliates node.                                           |
| [packages/app](./packages/app)           | Next.js app provides a user-friendly interface for managing and interacting with ChainFiliates functionalities. |
...
```bash
git clone https://github.com/chainfiliateslabs/chainfiliates.git
cd chainfiliates
```

2. To install dependencies, run `pnpm install` in the root directory.

   > ChainFiliates Core is a monorepo with multiple packages in the `packages` directory. Each package has its own `package.json` and scripts. Learn more about [PNPM Workspaces](https://pnpm.io/workspaces).

3. For package overviews and instructions to start services, refer to the respective package documentation.

## **🚀** Usage and Deployment

Users can interact with your deployed ChainFiliates Core node in two ways:

- By using the frontend interface deployed by the same node
- By integrating directly with your servers, utilizing [User Programs](https://github.com/chainfiliateslabs/programs)
...
[This guide provided at `packages/app`](./packages/app/README.md#how-to-run-it) will help you set up the Next.js application for ChainFiliates Core.
...
[This guide provided at `packages/graph`](./packages/graph/README.md#setting-up-an-arangodb-instance) will help you set up ArangoDB for ChainFiliates Core.

By following it, you will be able to:

- Set up an ArangoDB instance on ArangoDB Cloud or on-premise, even at your local machine
- Set up a database and a database user for ChainFiliates Core usage
...
- Install ArangoMiGO
- Run the migration files to create and update the database structure required by ChainFiliates Core

### Setting up the Listener Node _(Optional)_

[This guide provided at `packages/listener`](./packages/listener/README.md#deploy) will help you set up the Listener Node for ChainFiliates Core.
...
By default, you can use ChainFiliates's Public Ceramic Node for Production purposes - **hosted at [https://ceramic.chainfiliates.so](https://ceramic.chainfiliates.so)**.

If you prefer to manage your own Cermaic Node for administative purposes, [the guide outlined in `packages/ceramic`](./packages/ceramic/README.md#ceramic) will help you set up a Ceramic node for ChainFiliates Core.
...
- **[Set up ArangoDB Cloud or On-Premise](https://www.arangodb.com/)** to handle ChainFiliates's data. Refer to the `graph`
  package to learn more.
- **[Create a Sentry account](https://sentry.io/signup/)** to enable error tracking and monitoring for your ChainFiliates Core
  deployment. This will help you identify and resolve issues more efficiently, ensuring a smoother user experience.

But bear in mind that these are not mandatory steps. You may choose to deploy ChainFiliates Core using other preferred services as well.

## 😵‍💫 Troubleshooting

- Don’t forget to check if our [Documentation](https://docs.chainfiliates.so/) already covers you
- For questions, support, and discussions: [Join the ChainFiliates Discord →](https://go.chainfiliates.so/discord)
- For bugs and feature requests: [Create an issue on Github →](https://github.com/chainfiliateslabs/core/issues)

## 🤔 **Missing Something Important to You?**

We know that everyone has different needs, and we want ChainFiliates to be as helpful and adaptable as possible. If you think
we're missing a feature that would make a big difference for you, we're all ears!

To suggest a new feature, just head over to our **[GitHub repository](https://github.com/chainfiliateslabs/chainfiliates)** and create a
new issue. Remember to add the `suggestion` tag to your issue, so we can find and prioritize your request.

Our team is always working to enhance and grow ChainFiliates, and your input is super valuable in guiding the project's future.
By sharing your suggestions, you're helping to improve the ChainFiliates community and make the product even better for
everyone. So, if you have a cool idea, don't hesitate to let us know!

## 💚 Contributing

There are many ways you can contribute to taking ChainFiliates’s mission to empower partnerships even further.
...
- Engage with our community on our [Discord server](https://go.chainfiliates.so/discord) or
  our [Twitter profile](https://twitter.com/chainfiliates_web3)
- What about writing an article and exposing it somewhere? How great would be to help people know there is ChainFiliates out
...
- [ ] Enable Plugins where Operators can simply enhance their ChainFiliates instance with integrations.
- [ ] Decentralise data and funds management to simplify Operator deployments and management.

## Example Campaigns

[See Documentation](https://docs.chainfiliates.so/grow-your-brand/the-campaign-object) to learn more about the meaning of the following objects/properties.
...
```json
{
	...
	"events": [
		{
			...
			"rate": 0.5,
			"description": "brands submit their partnership program setup via the ChainFiliates Campaign Onboarding Form"
		},
		{
			"strategy": "flat",
			// Rewards 0.05 AR tokens per conversion
			"rate": 0.05,
			"description": "brands submit their interest for a partnership program on the ChainFiliates website"
		}
	],
	"reward": {
		"name": "Arweave",
	...
	"details": {
		"destination_url": "https://go.chainfiliates.so/start-a-campaign?ref=chainfiliates_dapp",
		"name": "ChainFiliates ❤️ Arweave Reseller Program",
		"description": "Refer Web3 Brands building & growing on the Arweave Blockchain to ChainFiliates and earn up to 50% commission when Rewards are claimed from their Campaigns.",
		"image": "https://chainfiliates-pub.s3.amazonaws.com/onlyarweave-posh.png"
	},
	"advertiser": {
		"name": "ChainFiliates",
		"icon": "https://pages.chainfiliates.so/wp-content/uploads/2022/03/chainfiliates-logo-medium.png",
		"description": "Partnerships for Web3",
		"external_link": "https://chainfiliates.so",
		"twitter": "https://twitter.com/chainfiliates_web3"
	},
...
```json
{
	...
	"details": {
		...
		"name": "ChainFiliates ❤️ Ethereum Reseller Program",
		"description": "Refer Web3 Brands building & growing on the Ethereum Blockchain to ChainFiliates and earn up to 50% commission when Rewards are claimed from their Campaigns."
	},
	"advertiser": {
		"name": "ChainFiliates",
		"icon": "https://pages.chainfiliates.so/wp-content/uploads/2022/03/chainfiliates-logo-medium.png",
...
Copyright (c) 2022 ChainFiliates Labs Pty Ltd & Ryan Soury
...
ChainFiliates is a collaborative effort, and we want to extend our gratitude to all contributors who have helped shape and improve the software.
